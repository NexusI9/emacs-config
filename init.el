...
(custom-set-variables
 ...
 '(package-selected-packages
   '(php-mode php-cs-fixer git-gutter ef-themes sublime-themes esmond-theme gruber-darker-theme subatomic-theme color-theme-sanityinc-tomorrow format-all dashboard lsp-treemacs lsp-mode company))
