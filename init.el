...
(custom-set-variables
 ...
 '(package-selected-packages
   '(yasnippet-snippets astro-ts-mode treesit-auto php-mode php-cs-fixer git-gutter ef-themes sublime-themes esmond-theme gruber-darker-theme subatomic-theme color-theme-sanityinc-tomorrow dashboard lsp-treemacs lsp-mode company))
